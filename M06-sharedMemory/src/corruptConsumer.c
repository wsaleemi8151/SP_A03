...
int main (void)
{
	...
	while(!done)
	{
	  ...
	  printf ("4 ... Slightly Corrupt Shared Memory\n");
	  printf ("5 ... Really Corrupt Shared Memory\n");
	  printf ("6 ... Quit\n");
	  printf ("\nEnter your choice: ");
	  gets (buffer);
	  x = atoi (buffer);
	  ...
	  switch (x) 
	  {
	   ...
	   case 4:
	   {
	     printf("(CONSUMER) Corrupting the shared-memory - but the PRODUCER probably won't notice\n");
	     p->pos = 301;
	     break;
	   }
	   case 5:
	   {
	     printf("(CONSUMER) Corrupting the shared-memory - the PRODUCER is gonna feel this !!\n");
	     p->pos = 54451201;
	     break;
	   }
	   case 6:
